...
│  Browser/Client                                                 │
│       ↓                                                         │
│  Kong Gateway (Port 8000) ← Rate Limiting, CORS, Routing       │
│       ↓                                                         │
│  Frontend (React - Port 3000) ← UI, State Management           │
│       ↓                                                         │
│  Backend API (Node.js - Port 5000) ← Business Logic, Auth      │
│       ↓              ↓                                          │
│  MongoDB (Port 27017)  Redis (Port 6379) ← Data & Cache        │
│       ↓                                                         │
│  Monitoring Stack:                                              │
